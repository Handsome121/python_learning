...
![1611815644602](../图片/1611815644602.png)

**2，docker run**

有了“可执行程序”image后就可以运行程序了，接下来使用命令docker run，docker daemon接收到该命令后找到具体的image，然后加载到内存开始执行，image执行起来就是所谓的container。

![1611815700067](../图片/1611815700067.png)
...
![1611815823299](../图片/1611815823299.png)
